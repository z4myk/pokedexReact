    ...
    <>
     {!searchData ? (
      ...
      <input
        ...
        className="form-control w-50 container border-danger mt-5"
        ...
        {props.pokemon && (
          <div className="cardbodySearch">
            ...
            <div className="d-flex">
              ...
              <span className="my-3 text-center">Nombre: {props.pokemon.name}</span>
              <hr className="text-danger" />
              <span className="text-center">Peso: {props.pokemon.weight}kg</span>
              <br />
              <span className="text-center">Especie: {props.pokemon.types.map(type => (
             <span key={type.type.name}>{type.type.name}</span>
              ))} </span>
              <br />
              <span className="text-center">Habilidad: {props.pokemon.abilities.map(hability => (
